<script lang="ts">
	import Icon from '$lib/components/my/LucideIcon.svelte';
					...
					<div class="flex flex-wrap items-center justify-between py-2 gap-6 md:py-4 md:gap-0 relative">
							...
							<div class="relative z-20 w-full flex justify-between lg:w-max md:px-0">
									<a href="#home" aria-label="logo" class="flex space-x-2 items-center">
											<span class="text-2xl font-bold text-gray-900 dark:text-white">Andndre</span>
									</a>
									
									<div class="relative flex items-center lg:hidden max-h-10">
										<label for="toggle_nav" aria-label="humburger" id="hamburger" class="relative  p-6 -mr-6">
							...
							<div class="flex-col z-20 flex-wrap gap-6 p-8 rounded-3xl border border-gray-100 bg-white shadow-2xl shadow-gray-600/10 justify-end w-full invisible opacity-0 translate-y-1  absolute top-full left-0 transition-all duration-300 scale-95 origin-top 
									...
									<div class="mt-12 lg:mt-0 mb-12 lg:mb-0">
										<Button on:click={() => {toggleMode()}} class="p-2" variant="outline">
											<Icon className="h-4 dark:hidden" name="Sun"/>
											<Icon className="h-4 hidden dark:block" name="Moon"/>
										</Button>
									</div>
									...
									<div class="text-gray-600 dark:text-gray-300 lg:pr-4 lg:w-auto w-full lg:pt-0">
											<ul class="tracking-wide font-medium lg:text-sm flex-col flex lg:flex-row gap-6 lg:gap-0">
													<li>
															<a href="#about-me" class="block md:px-4 transition hover:text-primary">
																	<span>Tentang Saya</span>
															</a>
													</li>
													<li>
															<a href="#projects" class="block md:px-4 transition hover:text-primary">
																	<span>Projects</span>
															</a>
													</li>
													<li>
															<a href="#techs" class="block md:px-4 transition hover:text-primary">
																	<span>Tech</span>
															</a>
													</li>
											</ul>
									...
									<div class="mt-12 lg:mt-0">
										<Button variant="outline" href="mailto:agungandre687@gmail.com">Hubungi Saya</Button>
									</div>
							</div>
					</div>
			</Container>
